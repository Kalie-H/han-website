...
function getNumberBackgroundColor(number) {
    switch (number) {
        case 2:
            return "url(game/2.png)";
            break;
        case 4:
            return "url(game/4.png)";
            break;
        case 8:
            return "url(game/8.png)";
            break;
        case 16:
            return "url(game/16.png)";
            break;
        case 32:
            return "url(game/32.png)";
            break;
        case 64:
            return "url(game/64.png)";
            break;
        case 128:
            return "url(game/128.png)";
            break;
        case 256:
            return "url(game/256.png)";
            break;
        case 512:
            return "url(game/512.png)";
            break;
        case 1024:
            return "url(game/1024.png)";
            break;
        case 2048:
            return "url(game/2048.png)";
            break;
        case 4096:
            return "url(game/4096.png)";
            break;
        case 8192:
            return "url(game/8192.png)";
            break;
    }
    return "black";
}
